                    ...
                    <form action="<?= base_url('in/add_form'); ?>" method="post" id="form_material">
                        <div class="form-row">
                            ...
                            <div class="col-md-3 mb-1">
                                ...
                                <input type="date" class="form-control form-control-sm" name="dates" placeholder="DD/MM/YYY" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control  form-control-sm tb-f mb-2" id="nama_barang" name="nama_barang" placeholder="Nama Barang" readonly>
                                <input type="text" class="form-control  form-control-sm tb-f mb-2" id="harga" name="harga" placeholder="Harga" readonly>
                                <input type="number" name="jumlah" class="form-control form-control-sm tb-f" id="jumlah" min="1" max="999999" placeholder="jumlah" onkeyup="hitung();">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control  form-control-sm tb-f mb-5" id="nama_supplier" name="nama_supplier" placeholder="" readonly>

                                <input type="number" id="total" name="total" class="form-control form-control-sm tb-f" min="1" max="999999" placeholder="total" readonly>
    ...
    $('#insert').click(function() {
        ...
        if (!checkEmptyInput()) {
            ...
            if ($('#insert').text() == 'Insert') {
                ...
                output += '<td><button type="button"  class="btn btn-danger btn-sm remove_details"  id="' + count + '">Del</button></td>';
                output += '</tr>';
                $('#table').append(output);
                $('.tb-f').val('');
            } else {
                ...
                output += '<td>' + total + ' <input type="hidden" name="hidden_total[]" id="total' + count + '" value="' + total + '" /></td>';
                output += '<td><button type="button"  class="btn btn-danger btn-sm remove_details"  id="' + row_id + '">Del</button></td>';

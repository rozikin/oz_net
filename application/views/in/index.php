        ...
        <div class="col-lg">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-2">
                    ...
                    <a href='<?= base_url('in/add_form') ?>' class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            "ajax": {
                url: '<?php echo site_url('in/product_data') ?>',
                type: 'POST'
            },
    ...
    function delete_data(id) {
        ...
        if (confirm('Are you sure delete this data?')) {
            ...
            $.ajax({
                url: "<?php echo site_url('in/delete_datax') ?>/" + id,
                type: "POST",
                dataType: "JSON",
    ...
    function edit(id) {
        var a = "<?php echo site_url('in/edit') ?>/" + id;

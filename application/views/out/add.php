        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="<?= base_url('out/add_form'); ?>" method="post" id="form_material">
                        <div class="form-row">

                            <div class="col-md-3 mb-1">
                                <label for="kode_out">Sale no</label>
                                <input type="text" class="form-control form-control-sm" id="kode_out" name="kode_out" value="<?= $kodeotomatis ?>" placeholder="" required readonly>
                            </div>

                            <div class="col-md-3 mb-1">
                                <label for="dates">Date</label>
                                <input type="date" id="dates" class="form-control form-control-sm" name="dates" placeholder="DD/MM/YYY" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control  form-control-sm tb-f mb-2" id="nama_barang" name="nama_barang" placeholder="nama_barang" readonly>
                                <input type="text" class="form-control  form-control-sm tb-f mb-2" id="harga" name="harga" placeholder="harga" readonly>
                                <input type="number" name="jumlah" id="jumlah" class="form-control form-control-sm tb-f" min="1" max="999999" rows="10" placeholder="jumlah" onkeyup="hitung();">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control  form-control-sm tb-f mb-5" id="nama_employee" name="nama_employee" placeholder="nama" readonly>
                                <input type="number" name="total" id="total" class="form-control form-control-sm tb-f" min="1" max="999999" rows="10" placeholder="total" readonly>
...
<script>
    ...
    function checkEmptyInput() {
        ...
        if (fname === "") {
            ...
            alert("kode pelanggan Connot Be Empty");
            isEmpty = true;
        } else if (age === "") {
...
<script type="text/javascript">
    ...
    function kd_otomatis() {
        $.ajax({
            url: "<?php echo site_url('out/kode_otomatis') ?>/",
            type: "GET",
            dataType: "JSON",
            success: function(data) {

                $('[name="kode_out"]').val(data);
            },
